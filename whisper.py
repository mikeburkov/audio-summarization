...
#    subprocess.run(["./main", "-otxt", "--output-file", output_file_main, "-m", "models/ggml-small.en-q5_1.bin", filename])
    subprocess.run(["/Users/mikeburkov/whisper.cpp/main", "-otxt", "--output-file", output_file_main, "-m", "/Users/mikeburkov/whisper.cpp/models/ggml-base.en.bin", "--split-on-word", filename])
    ...
    if os.path.exists(output_file):
        ...
        print("Type out the processed text")
        keyboard.type(processed_text)
        print("Print the processed text")
        print(processed_text)
        print(output_file_main)
        print(output_file)
